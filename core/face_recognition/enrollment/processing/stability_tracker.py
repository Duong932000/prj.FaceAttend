...
class StabilityTracker:
    def __init__(self, stability_cfg) -> None:
    ...
    def is_stable(self):
        ...
        centers = np.array(list(self.center_history), dtype=np.float32)
        ...
        return (
            center_std_x < self.center_std_max and
            center_std_y < self.center_std_y_max and
            yaw_std < self.yaw_std_max and
